...
void create_air_telemetry_menu(lv_obj_t * parent) {
    ...
    create_slider(cont,LV_SYMBOL_SETTINGS, "MCS Index", 0 , 9, 1);
    create_slider(cont,LV_SYMBOL_SETTINGS, "Aggregate", 0 , 15, 1);
    ...
    cont = lv_menu_cont_create(section);
    lv_obj_set_flex_flow(cont, LV_FLEX_FLOW_COLUMN);    
    create_slider(cont,LV_SYMBOL_SETTINGS, "RC Channel", 0 , 15, 1);
